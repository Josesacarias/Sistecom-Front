                        ...
                        <v-card>
                            ...
                            <v-container grid-list-md>
                                ...
                                <v-flex xs12 sm12 md12>
                                    <v-text-field v-model="nombre" label="Tema"></v-text-field>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <v-text-field v-model="codigo" label="Contacto">
                                    </v-text-field>
                                </v-flex>

                                 <v-flex xs6 sm6 md6>
                                    <v-text-field v-model="codigo" label="para">
                                    </v-text-field>
                                </v-flex>

                                <v-flex xs6 sm6 md6>
                                    <v-text-field v-model="codigo" label="Direccion de correo">
                                    </v-text-field>
                                </v-flex>
                                ...
                                <v-flex xs6 sm6 md6>
                                    ...
                                    :items="categorias" label="Asignar ticket">
                                    </v-select>
                                </v-flex>

                                <v-flex xs4 sm4 md4>
                                    <v-select v-model="idcategoria"
                                    :items="categorias" label="Prioridad ">
                                    </v-select>
                                    </v-flex>

                                    <v-flex xs4 sm4 md4>
                                    <v-select v-model="idcategoria"
                                    :items="categorias" label="Servicio ">
                                    </v-select>
                                    </v-flex>
                                    ...
                                    <v-flex xs6 sm6 md6>
                                    <v-select v-model="idcategoria"
                                    :items="categorias" label="Departamento">
                                    </v-select>
                                    </v-flex>
                                 ...
                                 <v-flex xs6 sm6 md6>
                                    ...
                                    :items="categorias" label="CC">
                                     ...
                                     <v-flex xs12 sm12 md12>
                                    <v-select v-model="idcategoria"
                                    :items="categorias" label="Agencia Solicitante">
                                    </v-select>
                                </v-flex>

                                
                                <v-flex xs3 sm3 md3>
                                    <v-text-field type="number" label="Ip Cliente">
                                    </v-text-field>
                                </v-flex>

                                <v-flex xs3 sm3 md3>
                                    <v-text-field type="number" label="IC/STB">
                                    </v-text-field>
                                </v-flex>

                                <v-flex xs3 sm3 md3>
                                    <v-text-field type="number" label="Mac">
                                    </v-text-field>
                                </v-flex>

                                <v-flex xs3 sm3 md3>
                                    <v-text-field type="number" label="Megas">
                                    </v-text-field>
                                </v-flex>
                                ...
                                <v-flex xs12 sm12 md12>
                                    <v-text-field  outline v-model="descripcion" label="Comentarios"></v-text-field>
                                </v-flex>

                                <v-flex xs12 sm12 md12>
                                    <v-text-field   append-icon ="fas fa-file-upload" label="Adjuntar archivos"></v-text-field>
