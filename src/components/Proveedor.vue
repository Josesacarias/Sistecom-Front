                    ...
                    <v-dialog v-model="dialog" max-width="500px">
                        ...
                        <v-card xs12 sm12 md12>
                            ...
                            <v-container grid-list-md>
                                ...
                                <v-flex xs6 sm6 md6>
                                    <v-text-field v-model="nombre" label="Nit">
                                    </v-text-field>
                                </v-flex>
                                ...
                                <v-flex xs6 sm6 md6>
                                    <v-text-field v-model="telefono" label="Numero de cuenta 1">
                                    </v-text-field>
                                </v-flex>

                                <v-flex xs6 sm6 md6>
                                    <v-text-field v-model="telefono" label="Numero de cuenta 2">
                                    </v-text-field>
                                </v-flex>
                                 ...
                                 <v-flex xs6 sm6 md6>
                                    <v-text-field v-model="telefono" label="Numero de cuenta 3">
                                    </v-text-field>
                                </v-flex>
                                 ...
                                 <v-flex xs12 sm6 md6>
                                    <v-select v-model="tipo_documento"
                                     label="Descuento">
                                        ...
                                        <v-flex xs6 sm6 md6>
                                    <v-text-field v-model="telefono" label="Acuerdo de Pago">
                                    </v-text-field>
                                </v-flex>
